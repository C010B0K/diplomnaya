...
export default function Input() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <input type='text' placeholder="Имя" {...register("Имя", {required: true, maxLength: 80, pattern: /Имя/i})} />
      ...
      <input type='date' placeholder="Дата и время" {...register("Дата и время", {required: true})} />
